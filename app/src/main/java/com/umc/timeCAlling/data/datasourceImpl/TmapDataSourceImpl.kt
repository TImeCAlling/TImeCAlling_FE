...
class TmapDataSourceImpl @Inject constructor(
    ...
    override suspend fun getRoute(startX: Double, startY: Double, endX: Double, endY: Double): TmapRouteResponseDto =
         tmapService.getRoute(TmapRouteRequestDto(startX, startY, endX, endY))
}