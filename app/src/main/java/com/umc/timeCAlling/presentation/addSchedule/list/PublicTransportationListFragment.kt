...
@AndroidEntryPoint
class PublicTransportationListFragment  : BaseFragment<FragmentLocationResultTransportationListBinding>(R.layout.fragment_location_result_transportation_list) {
    ...
    override fun initView() {
        viewModel.publicResult.observe(viewLifecycleOwner) { publicResult ->
            if (publicResult != null) { // API 호출 결과가 설정된 경우에만 초기화
